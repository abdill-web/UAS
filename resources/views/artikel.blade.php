...
<section id="artikel-terbaru" class="py-10 bg-white">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-lg overflow-hidden">
            <img src="/img/tupai.png" alt="Artikel 1" class="w-full h-60 object-cover"> <!-- Gambar diperbesar -->
            <div class="p-4">
        ...
        <!-- Artikel Samping 2 -->
        <div class="bg-white rounded-lg overflow-hidden">
            <img src="/img/becak.png" alt="Artikel 2" class="w-full h-60 object-cover"> <!-- Gambar diperbesar -->
            <div class="p-4">
                <p class="text-gray-700 font-semibold text-left">Penting! Cara Mudah agar Bisa Kuliah di Luar<br>Negeri dengan Beasiswa</p>
            </div>
        </div>
    ...
    <div class="container mx-auto px-4 sm:px-10">
        ...
        <div class="grid grid-cols-1 gap-0"> 
            ...
            <div class="grid grid-cols-2 items-center bg-white rounded-lg overflow-hidden p-2"> 
                <img src="/img/chinagraph.png" alt="Artikel 1" class="w-full h-72 object-contain">
                <div class="p-2">
            ...
            <!-- Artikel 2 -->
            <div class="grid grid-cols-2 items-center bg-white rounded-lg overflow-hidden p-2"> 
                <img src="/img/coconut.png" alt="Artikel 2" class="w-full h-72 object-contain">
                <div class="p-2">
                    <h4 class="text-lg font-semibold text-gray-800 text-left">Penting! Cara Mudah agar Bisa Kuliah di Luar Negeri dengan Beasiswa</h4>
                    <p class="text-sm text-gray-500 text-left">Selasa, 18 Feb 2020 12:01 WIB</p>
                </div>
            ...
            <!-- Artikel 3 -->
            <div class="grid grid-cols-2 items-center bg-white rounded-lg overflow-hidden p-2"> 
                <img src="/img/pantai.png" alt="Artikel 3" class="w-full h-72 object-contain">
                <div class="p-2">
                    <h4 class="text-lg font-semibold text-gray-800 text-left">Penting! Cara Mudah agar Bisa Kuliah di Luar Negeri dengan Beasiswa</h4>
                    <p class="text-sm text-gray-500 text-left">Selasa, 18 Feb 2020 12:01 WIB</p>
                </div>
            ...
            <!-- Artikel 4 -->
            <div class="grid grid-cols-2 items-center bg-white rounded-lg overflow-hidden p-2"> 
                <img src="/img/kastil.png" alt="Artikel 4" class="w-full h-72 object-contain">
                <div class="p-2">
                    <h4 class="text-lg font-semibold text-gray-800 text-left">Penting! Cara Mudah agar Bisa Kuliah di Luar Negeri dengan Beasiswa</h4>
                    <p class="text-sm text-gray-500 text-left">Selasa, 18 Feb 2020 12:01 WIB</p>
                </div>
            ...
            <!-- Artikel 5 -->
            <div class="grid grid-cols-2 items-center bg-white rounded-lg overflow-hidden p-2"> 
                <img src="/img/chinatown.png" alt="Artikel 5" class="w-full h-72 object-contain">
                <div class="p-2">
                    <h4 class="text-lg font-semibold text-gray-800 text-left">Penting! Cara Mudah agar Bisa Kuliah di Luar Negeri dengan Beasiswa</h4>
                    <p class="text-sm text-gray-500 text-left">Selasa, 18 Feb 2020 12:01 WIB</p>
                </div>
